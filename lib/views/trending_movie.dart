  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          SliverAppBar.large(     
            leading:const BackBtn(),   // leading:     ده المكون الاول لل  SliverAppBar.large ومساحته بتكون صغيرة واللي هي زرار الرجوع فقط
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: ClipRRect(
                ...
                child: Image.network(
                  '${Constants.imagePath}${resultModel.backdrop_path}',
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              const   Icon(
                                ...
                                Text(
                                  '${resultModel.vote_average.toStringAsFixed(1)}/10',
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 17,
                                    fontWeight: FontWeight.bold,
